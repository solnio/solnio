<?php
    ...
    $tabs = array(
        array(
            'id'      => 'redux-help-tab-1',
            'title'   => __( 'Theme Information 1', 'solnio' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'solnio' )
        ),
        array(
            'id'      => 'redux-help-tab-2',
            'title'   => __( 'Theme Information 2', 'solnio' ),
            'content' => __( '<p>This is the tab content, HTML is allowed.</p>', 'solnio' )
        )
    );
    ...
    $content = __( '<p>This is the sidebar content, HTML is allowed.</p>', 'solnio' );
